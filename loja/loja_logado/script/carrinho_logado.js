...
if (carrinho_com_conta) {
    Carrinho_sem_conta = carrinho_com_conta;
}
...
if (carrinho_com_conta) {
    ...
    for (let i = 0; i <= tamanho_carrinho; i++) {
        ...
        console.log("idskkkkkkk   ", qtds_carrinho[i]);
    }
}
...
function Adicionar_produtos_ao_carrinho(id_do_produto) {
    ...
    for (let i = 1; i < total_produtos; i++) {
        if ((verificacao && carrinho_com_conta[id_do_produto]) || Carrinho_sem_conta[id_do_produto]) {
